...
declare namespace PhonegapPluginPush {
  ...
  interface AndroidPushNotification {
    new (): AndroidPushNotification;
    /**
     *
     * @param appId 对于华为，则是读取agconnect-services里面的Appid
     */
    getAndroidToken(appId: string): Promise<any>;
    /**
     *
     * @param appId 对于华为，则是读取agconnect-services里面的Appid，消息通过window.addEventListner("receiveandroidpushmessage")返回
     */
    subscribeAndroidMessage(appId?: string): Promise<any>;
    /**
     *
     * @param appId 华为可用，则是读取agconnect-services里面的Appid
     */
    deleteToken(appId: string): Promise<any>;
    /**
     * 获取制造商，判断平台
     */
     ...
     * @param appKey
     */
    registerMiPush(appId: string, appKey: string): Promise<string>;
    /**
     *
     * @param appId
     * @param appKey
     */
    registerViVoToken(appId: string, appKey: string, appSecret: string): Promise<string>;
    initViVoPush(): Promise<any>;
    
    getOppoRegisterId(appKey: string, appSecret: string): Promise<string>;
