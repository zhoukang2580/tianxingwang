...
@Component({
  ...
  templateUrl: "./internationalflight-outnumber.component.html",
  styleUrls: ["./internationalflight-outnumber.component.scss"],
  animations: [flyInOut],
})
export class InternationalFlightOutNumberComponent
