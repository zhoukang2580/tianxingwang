...
@Component({
  selector: "app-hotel-starprice_en",
  templateUrl: "./hotel-starprice_en.component.html",
  styleUrls: ["./hotel-starprice_en.component.scss"]
})
export class HotelStarPriceEnComponent
