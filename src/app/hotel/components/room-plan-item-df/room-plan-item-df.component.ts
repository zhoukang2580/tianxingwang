...
@Component({
  selector: "app-room-plan-item-df",
  templateUrl: "./room-plan-item-df.component.html",
  styleUrls: ["./room-plan-item-df.component.scss"],
})
export class RoomPlanItemDfComponent implements OnInit, OnChanges {
