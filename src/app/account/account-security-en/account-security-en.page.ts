...
@Component({
  selector: "app-account-security-en",
  templateUrl: "./account-security-en.page.html",
  styleUrls: ["./account-security-en.page.scss"]
})
export class AccountSecurityEnPage implements OnInit, OnDestroy {
