...
@Component({
  selector: "app-account-mobile-en",
  templateUrl: "./account-mobile-en.page.html",
  styleUrls: ["./account-mobile-en.page.scss"],
})
export class AccountMobileEnPage implements OnInit, OnDestroy {
  action: string;
