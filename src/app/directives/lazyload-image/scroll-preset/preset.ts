...
export const isVisible: IsVisibleFn<Event> = (
  { element, offset, scrollContainer },
  getWindow = () => window
) => {
...
const getObservable: GetObservableFn<Event | String> = (
...
export const scrollPreset: HookSet<Event | String> = Object.assign(
  {},
  sharedPreset,
  {
    isVisible,
