...
export const isVisible: IsVisibleFn<IntersectionObserverEntry> = ({
  event
}) => {
  return event.isIntersecting;
};

export const getObservable: GetObservableFn<IntersectionObserverEntry> = (
...
export const intersectionObserverPreset: HookSet<
  IntersectionObserverEntry
> = Object.assign({}, sharedPreset, {
  isVisible,
  getObservable
});
