...
export function sampleObservable<T>(obs: Observable<T>, scheduler?: any): Observable<string | T> {
  return obs.pipe(
...
export const getScrollListener = (scrollTarget?: HTMLElement | Window): Observable<string | Event> => {
