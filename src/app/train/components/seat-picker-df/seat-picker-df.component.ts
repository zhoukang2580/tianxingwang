...
import { TrainSeatType } from '../../models/TrainEntity';
import { TrainSeatEntity } from '../../models/TrainSeatEntity';

@Component({
  selector: 'app-seat-picker-df',
  templateUrl: './seat-picker-df.component.html',
  styleUrls: ['./seat-picker-df.component.scss'],
})
export class SeatPickerDfComponent implements OnInit, AfterViewInit {
