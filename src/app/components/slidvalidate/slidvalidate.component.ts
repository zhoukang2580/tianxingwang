...
export class SlidvalidateComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    this.picContainerEle = this.pic.nativeElement;
    this.block = this.blockCanvasEl.nativeElement;
    this.canvas = this.canvasEl.nativeElement;
    // console.dir(this.el);
    this.w = this.plt.width() * 0.8;
    this.h = 0.7 * this.plt.width();
    this.init();
  }
  ...
  initDOM() {
    ...
    this.render.setStyle(this.picContainerEle, 'width', this.w + "px");
    ...
    this.sliderContainer = this.picContainerEle.querySelector(".sliderContainer");//  this.createElement('div','sliderContainer');
    this.refreshIcon = this.picContainerEle.querySelector(".refreshIcon");// this.createElement('div', 'refreshIcon')
    this.sliderMask = this.picContainerEle.querySelector(".sliderMask");// this.createElement('div', 'sliderMask')
    this.slider = this.picContainerEle.querySelector(".slider");//this.createElement('div', 'slider')
    this.sliderIcon = this.picContainerEle.querySelector(".sliderIcon");//this.createElement('span', 'sliderIcon')
    this.text = this.picContainerEle.querySelector(".sliderText");// this.createElement('span', 'sliderText')
