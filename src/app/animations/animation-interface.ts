...
export declare type AnimationKeyFrames = AnimationKeyFrame[];
export declare type AnimationStyles = Record<string, any>;
...
export declare type AnimationPlayTo = "start" | "end";
export declare type AnimationDirection =
  | "normal"
  | "reverse"
  | "alternate"
  | "alternate-reverse";
export declare type AnimationFill =
  | "auto"
  | "none"
  | "forwards"
  | "backwards"
