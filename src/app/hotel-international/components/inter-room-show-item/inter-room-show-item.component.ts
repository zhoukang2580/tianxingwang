import { InternationalHotelService, IInterHotelInfo } from "../../international-hotel.service";
...
@Component({
  selector: "app-inter-room-show-item",
  templateUrl: "./inter-room-show-item.component.html",
  styleUrls: ["./inter-room-show-item.component.scss"]
})
export class InterRoomShowItemComponent implements OnInit, OnChanges {
  ...
  @Input() bookInfo: PassengerBookInfo<IInterHotelInfo>;
