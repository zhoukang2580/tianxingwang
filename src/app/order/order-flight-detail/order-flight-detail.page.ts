...
@Component({
  ...
  templateUrl: "./order-flight-detail.page.html",
  styleUrls: ["./order-flight-detail.page.scss"],
  animations: [flyInOut],
})
export class OrderFlightDetailPage implements OnInit, AfterViewInit, OnDestroy {
