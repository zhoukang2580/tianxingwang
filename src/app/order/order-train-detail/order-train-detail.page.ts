...
@Component({
  selector: "app-order-train-detail",
  templateUrl: "./order-train-detail.page.html",
  styleUrls: ["./order-train-detail.page.scss"],
  animations: [flyInOut],
})
export class OrderTrainDetailPage implements OnInit, AfterViewInit, OnDestroy {
