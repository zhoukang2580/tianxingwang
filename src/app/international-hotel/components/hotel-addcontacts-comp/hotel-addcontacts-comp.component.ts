...
@Component({
  selector: "app-inter-hotel-addcontacts-comp",
  templateUrl: "./hotel-addcontacts-comp.component.html",
  styleUrls: ["./hotel-addcontacts-comp.component.scss"],
})
export class InterHotelAddcontactsCompComponent implements OnInit {
