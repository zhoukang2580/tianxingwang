...
import { PassengerEntity } from "./flightgp/PassengerEntity";
import { AccountCardEntity } from "./AccountCardEntity";
...
export interface FrequentBookInfo{
  passengerEntity?: PassengerEntity;
}

export interface CardBinsBookInfo{
...
export interface FlightSegmentModel {
  ...
  LowerSegmentFlightLowerFare; // String 最低价舱位
