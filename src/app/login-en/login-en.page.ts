...
export class LoginEnPage implements OnInit, OnDestroy, AfterViewInit {
      ...
      case "wechat": {
        ...
        this.loginSubscription = this.loginService
          ...
          .subscribe(
            ...
            (e) => {
              AppHelper.alert("wechat login faild");
            }
          );
        break;
      }
      case "wechatMiniMobile": {
        ...
        this.loginSubscription = this.loginService
          ...
          .subscribe(
            ...
            (e) => {
              this.message = e || "Login failed. Please try other ways";
              AppHelper.alert(e || "Login failed. Please try other ways");
            }
          );
        break;
      }
  ...
  getWechatMiniMobile() {
    ...
    const desc = "The application needs to get your mobile phone number to complete the login";
