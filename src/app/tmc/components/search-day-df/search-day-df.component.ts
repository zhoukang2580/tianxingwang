...
@Component({
  selector: "app-search-day-comp-df",
  templateUrl: "./search-day-df.component.html",
  styleUrls: ["./search-day-df.component.scss"],
})
export class SearchDayDfComponent implements OnInit, OnChanges {
